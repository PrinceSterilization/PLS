<%@ Page Title="Void Reasons" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="voidingreasons.aspx.cs" Inherits="Sterilization.voidingreasons" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentHolder" runat="server">
     <script type="text/javascript">
        ...
        function ClearControls(e) {
            ...
            $(".modal-title").text('');
            $('.modal-title').prepend("New Void Reason");
            var grvProduct = document.getElementById('<%=grvVoidReasons.ClientID%>');
        ...
        $(function () {
            $('.GridRow').click(function () {
                ...
                $(".modal-title").text('');
                $('.modal-title').prepend("Edit Void Reason");
                var grvVoidReasons = document.getElementById('<%=grvVoidReasons.ClientID%>');
                ...
                document.getElementById('<%=txtReasonDescription.ClientID%>').value = grvVoidReasons.rows[ri].cells[1].innerHTML;
                document.getElementById('<%=hdnreasonid.ClientID%>').value = grvVoidReasons.rows[ri].cells[0].innerHTML;
    ...
    <style type="text/css">
     ...
     <div class="content ">
        ...
        <div class="row">
            <div class="col-md-2">
                <button type="button" id="btnadd" class="btn btn-primary btn-md" data-toggle="modal" onclick="ClearControls('A');" data-target="#myModal">Add Void Reason</button>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div id="UserGridScroll" class="grid_scroll">
                    <asp:GridView ID="grvVoidReasons" runat="server"
                        ...
                        BorderWidth="1px" Width="900px" OnRowDataBound="grvVoidReasons_RowDataBound" OnSorting="grvVoidReasons_Sorting">

                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <asp:DropDownList ID="ddlMasterFormats" runat="server" CssClass="btn btn-default btn-md" Style="width: 100%;">
                            ...
                            <asp:ListItem Value="PSS_Product_2_1_SKU">1</asp:ListItem>
                            <asp:ListItem Value="PSS_Product_2_2_SKU_Paragraph">2</asp:ListItem>
                            <asp:ListItem Value="PSS_Product_2_3_CAT">3</asp:ListItem>
                            <asp:ListItem Value="PSS_Product_2_4_CAT_Paragraph">4</asp:ListItem>
                            <asp:ListItem Value="PSS_Product_2_5_CAT_Paragraph">5</asp:ListItem>
                            <asp:ListItem Value="PSS_Product_2_6_SKU">6</asp:ListItem>
                            <asp:ListItem Value="PSS_Product_2_7_SKU">7</asp:ListItem>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <asp:DropDownList ID="ddlCaseFormats" runat="server" CssClass="btn btn-default btn-md" Style="width: 100%;">
                            <asp:ListItem Value="0">--Select--</asp:ListItem>
                            <asp:ListItem Value="PSS_InsertBox_3_1_SKU">1</asp:ListItem>
                            <asp:ListItem Value="PSS_InsertBox_3_2_SKU_Paragraph">2</asp:ListItem>
                            <asp:ListItem Value="PSS_InsertBox_3_3_CAT">3</asp:ListItem>
                            <asp:ListItem Value="PSS_InsertBox_3_4_CAT_Paragraph">4</asp:ListItem>
                            <asp:ListItem Value="PSS_InsertBox_3_5_CAT_Paragraph">5</asp:ListItem>
                            <asp:ListItem Value="PSS_InsertBox_3_6_SKU">6</asp:ListItem>
                            <asp:ListItem Value="PSS_InsertBox_3_7_SKU">7</asp:ListItem>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <asp:DropDownList ID="ddlInsertFormats" runat="server" CssClass="btn btn-default btn-md" Style="width: 100%;">
                            <asp:ListItem Value="0">--Select--</asp:ListItem>
                            <asp:ListItem Value="PSS_Case_4_1_SKU">1</asp:ListItem>
                            <asp:ListItem Value="PSS_Case_4_2_SKU_Paragraph">2</asp:ListItem>
                            <asp:ListItem Value="PSS_Case_4_3_CAT">3</asp:ListItem>
                            <asp:ListItem Value="PSS_Case_4_4_CAT_Paragraph">4</asp:ListItem>
                            <asp:ListItem Value="PSS_Case_4_5_SKU_Paragraph_GBL">5</asp:ListItem>
                            <asp:ListItem Value="PSS_Case_4_6_CAT_Paragraph">6</asp:ListItem>
                            <asp:ListItem Value="PSS_Case_4_7_SKU_Paragraph">7</asp:ListItem>
